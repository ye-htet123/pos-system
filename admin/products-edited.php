                ...
                <div class="form-section">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="cost" id="cost" value="<?= $product['data']['cost'];?>"  required class="form-control">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="description" class="form-label">Description</label>
                            <textarea name="description" id="description" class="form-control" rows="2"><?= $product['data']['description'];?></textarea>
                        </div>
                ...
                <div class="form-section">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="file" name="image" id="image" class="form-control" value="<?= $product['data']['image'];?>">
                ...
                <div class="form-section">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3 text-end">
                            <button type="submit" name="updateProduct" class="btn btn-primary px-4">
